...
myBaseWmApps="polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman"
...
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock"
myBaseI3wm="i3 i3lock xss-lock i3status dmenu"
myBaseGlobalApps="gimp inkscape shotcut code qbittorrent gparted chromium firefox alacritty bitwarden discord ark libreoffice-fresh xreader kdeconnect dragon elisa"
myBaseSteam="steam"
