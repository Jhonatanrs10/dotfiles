...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman alacritty"
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman alacritty"
myBaseI3wm="i3 i3lock xss-lock i3status dmenu"
myBaseGlobalApps="gimp inkscape shotcut code qbittorrent gparted firefox bitwarden discord ark libreoffice-fresh xreader kdeconnect dragon elisa"
myBaseSteam="steam"
