...
myBaseKde="dolphin dolphin-plugins dragon elisa filelight gwenview leafpad okular kcalc konsole plasma-meta sddm"
...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman"
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman"
myBaseI3wm="i3 i3lock xss-lock i3status dmenu"
myBaseGlobalApps="gimp inkscape shotcut code qbittorrent gparted firefox alacritty bitwarden discord ark libreoffice-fresh xreader kdeconnect dragon elisa"
myBaseSteam="steam"
