...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm-gtk3 galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman alacritty"
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh mpv nwg-look lxappearance font-manager pcmanfm-gtk3 galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet pavucontrol blueman alacritty"
