...
myBaseHyprland="hyprland rofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring baobab seahorse network-manager-applet wiremix blueman alacritty ly"
