...
myBaseUtilitys="nano neovim brightnessctl fastfetch yt-dlp stow curl jq imagemagick cmatrix btop ranger xsel pacman-contrib base-devel git ffmpeg fwupd samba udisks2 gvfs gvfs-mtp gvfs-smb gvfs-afc polkit net-tools joyutils man-db wireless_tools"
...
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh nwg-look lxappearance font-manager thunar tumbler galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet wiremix blueman alacritty ly"
myBaseI3wm="i3 i3lock xss-lock i3status rofi dmenu ly"
