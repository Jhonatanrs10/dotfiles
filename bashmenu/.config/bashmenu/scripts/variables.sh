...
myBaseHyprland="hyprland rofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh nwg-look nwg-display lxappearance font-manager thunar galculator system-config-printer cmus gnome-keyring baobab seahorse network-manager-applet wiremix blueman alacritty ly"
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh nwg-look lxappearance font-manager thunar galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet wiremix blueman alacritty ly"
