...
myBaseUtilitys="nano neovim brightnessctl fastfetch yt-dlp stow curl jq imagemagick cmatrix btop xsel pacman-contrib base-devel git ffmpeg fwupd samba udisks2 gvfs gvfs-mtp gvfs-smb polkit net-tools joyutils man-db wireless_tools"
...
myBaseHyprland="hyprland rofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp polkit-gnome feh nwg-look nwg-display lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring baobab seahorse network-manager-applet wiremix blueman alacritty ly"
myBaseBspwm="bspwm sxhkd polybar rofi picom scrot xcolor lxrandr i3lock polkit-gnome feh nwg-look lxappearance font-manager pcmanfm galculator system-config-printer cmus gnome-keyring seahorse network-manager-applet wiremix blueman alacritty ly"
myBaseI3wm="i3 i3lock xss-lock i3status rofi dmenu ly pcmanfm"
