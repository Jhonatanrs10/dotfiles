...
local closeWindowBind2 = hl.bind("ALT + F4", hl.dsp.window.close())
...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("xdg-open https:"))
...
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.window.resize({x = 480, y = 270, relative = false,}))
...
-- Others
hl.bind(mainMod .. "+ SHIFT + R", hl.dsp.exec_cmd("~/.config/jrs/jrs-exec-reload-wm.sh"))
