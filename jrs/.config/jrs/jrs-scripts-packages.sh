...
myBaseHyprland="hyprland waybar hyprlock hyprshutdown hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp nwg-displays"
