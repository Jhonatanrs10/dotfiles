...
wmBluetoothControl="blueman"
wmNetworkManager="network-manager-applet"
wmKeyring="gnome-keyring seahorse"
wmDiskStatus="baobab"
wmMusicPlayer="cmus"
wmPrinters="system-config-printer"
wmCalculator="galculator"
wmFontManager="font-manager"
wmImageViewer="feh"
